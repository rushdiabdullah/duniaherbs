...
const CONTENT_GROUPS: Record<string, ContentGroup> = {
  ...
  Produk: {
    keys: ['produk_label', 'produk_title', 'produk_subtitle'],
    guide: 'Tajuk seksyen produk di homepage — "Koleksi Unggulan" / "Produk Mustajab". Produk sendiri diurus di halaman Produk',
    preview: '/#produk',
  },
  Sejarah: {
...
const FIELD_HINTS: Record<string, string> = {
  ...
  produk_title: 'Contoh: "Produk Mustajab"',
